    ...
    >
      ...
      >
        ...
        <div style={{ flex: "0.8", paddingLeft: "4rem" }}>
          ...
          >
            Explore the latest editorial campaign. A curated selection of
            silhouettes designed to move with you through the changing seasons.
          </motion.p>
          ...
          >
            <Link
              ...
              style={{ padding: "1rem 2.5rem", fontSize: ".8rem" }}
            >
