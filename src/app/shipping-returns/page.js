...
export default function ShippingReturnsPage() {
  return (
    <div className="info-page">
      ...
      <p>
        All orders are carefully wrapped in our signature recycled packaging.
        You&apos;ll receive tracking details via email once your order ships.
      </p>

      <h2>Returns</h2>
      <p>
        We want you to love every piece. If something doesn&apos;t feel right,
      ...
      <h2>Exchanges</h2>
      <p>
        Need a different size? We&apos;re happy to exchange. Simply initiate a
        return and place a new order for the correct size. We&apos;ll prioritise
      ...
      <div className="info-grid">
        ...
        <div className="info-card">
          ...
          <p>
            Please contact us within 2 hours of placing your order if you need
            to make changes. After that, we may not be able to modify it.
          </p>
        </div>
        <div className="info-card">
          <h3>Do you ship internationally?</h3>
          <p>
            Yes, we ship to 46 countries. International shipping rates are
        ...
        <div className="info-card">
          ...
          <p>
            Refunds are processed within 5-7 business days of us receiving your
            return. You&apos;ll receive a confirmation email once processed.
          </p>
        </div>
      </div>
    </div>
