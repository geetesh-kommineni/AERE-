...
export default function SizingGuidePage() {
  ...
  const calculateSize = () => {
    if (gender === "women") {
      ...
      else if (currentBustCm <= 84) {
        score.XS += 3;
        score.S += 1;
      } else if (currentBustCm <= 88) {
        score.S += 3;
        score.XS += 1;
        score.M += 1;
      } else if (currentBustCm <= 92) {
        score.M += 3;
        score.S += 1;
        score.L += 1;
      } else if (currentBustCm <= 96) {
        score.L += 3;
        score.M += 1;
        score.XL += 1;
      } else {
      ...
      else if (currentWaistCm <= 66) {
        score.XS += 3;
        score.S += 1;
      } else if (currentWaistCm <= 70) {
        score.S += 3;
        score.XS += 1;
        score.M += 1;
      } else if (currentWaistCm <= 74) {
        score.M += 3;
        score.S += 1;
        score.L += 1;
      } else if (currentWaistCm <= 78) {
        score.L += 3;
        score.M += 1;
        score.XL += 1;
      } else {
      ...
      else if (currentHipsCm <= 92) {
        score.XS += 3;
        score.S += 1;
      } else if (currentHipsCm <= 96) {
        score.S += 3;
        score.XS += 1;
        score.M += 1;
      } else if (currentHipsCm <= 100) {
        score.M += 3;
        score.S += 1;
        score.L += 1;
      } else if (currentHipsCm <= 104) {
        score.L += 3;
        score.M += 1;
        score.XL += 1;
      } else {
      ...
      if (currentBustCm < 91) score.S += 3;
        ...
        score.S += 3;
        score.M += 1;
      } else if (currentBustCm <= 101) {
        score.M += 3;
        score.S += 1;
        score.L += 1;
      } else if (currentBustCm <= 106) {
        score.L += 3;
        score.M += 1;
        score.XL += 1;
      } else if (currentBustCm <= 111) {
        score.XL += 3;
        score.L += 1;
        score.XXL += 1;
      } else {
      ...
      else if (currentWaistCm <= 81) {
        score.S += 3;
        score.M += 1;
      } else if (currentWaistCm <= 86) {
        score.M += 3;
        score.S += 1;
        score.L += 1;
      } else if (currentWaistCm <= 91) {
        score.L += 3;
        score.M += 1;
        score.XL += 1;
      } else if (currentWaistCm <= 96) {
        score.XL += 3;
        score.L += 1;
        score.XXL += 1;
      } else {
      ...
      else if (currentHipsCm <= 40) {
        score.M += 3;
        score.S += 1;
        score.L += 1;
      } else if (currentHipsCm <= 42) {
        score.L += 3;
        score.M += 1;
        score.XL += 1;
      } else if (currentHipsCm <= 44) {
        score.XL += 3;
        score.L += 1;
        score.XXL += 1;
      } else {
      ...
      switch (size) {
        case "XS":
          return {
            ...
            advice:
              "Perfect for a structured look. Select your standard size. If you prefer a highly fluid, draped flow, consider ordering a size S.",
        ...
        case "S":
          return {
            ...
            advice:
              "True to size. Offers an unhurried, comfortable contour. Our standard S offers a relaxed chest outline suitable for everyday movement.",
        ...
        case "M":
          return {
            ...
            advice:
              "Our benchmark medium offers a perfectly balanced silhouette. It breathes well, floats gracefully, and remembers natural lines.",
        ...
        case "L":
          return {
            ...
            advice:
              "If your bust or hip measurement is on the higher end of our scale, our L provides a spacious, elegant look without compromising sleek shoulder seams.",
        ...
        case "XL":
          return {
            ...
            advice:
              "Designed for ultimate comfort with extra fabric ease. Flows beautifully without clinging, ideal for quiet luxury layering.",
      ...
      switch (size) {
        case "S":
          return {
            ...
            advice:
              "Perfect for structured, custom linen shirt fits. Standard collar outline (38cm). If you prefer a relaxed, fluid drape, we recommend choosing size M.",
        ...
        case "M":
          return {
            ...
            advice:
              "Our benchmark medium offers a tailored armhole placement and an elegant 39-40cm collar outline. Moves with you comfortably.",
        ...
        case "L":
          return {
            ...
            advice:
              "If your chest measurement borders on the higher end of the scale, our L delivers a powerful drape without slouching seams.",
        ...
        case "XL":
          return {
            ...
            advice:
              "Designed for standard comfort and easy layering. Fits a 43-44cm collar comfortably without stiffness.",
        ...
        case "XXL":
          return {
            ...
            advice:
              "Offers ultimate ease and structural drape. Highly spacious across the chest and waist with a 45-46cm collar outline.",
  ...
  return (
    <>
      <div className="page-hero">
        ...
        <h1>
          Smart Sizing <em>Calculator</em>
        </h1>
        <p>
          Enter your measurements below for a bespoke fit recommendation.
          Designed for the unhurried silhouette.
        </p>
      </div>
      ...
      >
        ...
        <div
          ...
          className="calculator-layout-wrap"
        >
          {/* SLIDERS COLUMN */}
          <div
            className="luxury-glass-panel"
            style={{ padding: "3.5rem", borderRadius: 0 }}
          >
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              <div
                style={{
                  display: "inline-flex",
                  background: "rgba(158,139,124,0.1)",
                  borderRadius: 0,
                  padding: "3px",
                }}
              >
                <button
                  ...
                  style={{
                    border: "none",
                    background: unit === "cm" ? "var(--ink)" : "transparent",
                ...
                <button
                  ...
                  style={{
                    border: "none",
                    background: unit === "in" ? "var(--ink)" : "transparent",
            ...
            >
              ...
              >
                ...
                >
                  {bust}{" "}
                  <span style={{ fontSize: "0.75rem", color: "var(--taupe)" }}>
                    {unit}
                  </span>
                </span>
              </div>
            ...
            >
              ...
              >
                <span>
                  Min:{" "}
                  {unit === "cm" ? minCm[gender].waist : minIn[gender].waist}
                </span>
                <span>
                  Max:{" "}
                  {unit === "cm" ? maxCm[gender].waist : maxIn[gender].waist}
                </span>
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div
                    style={{
                      background: "rgba(201, 146, 122, 0.04)",
                      padding: "1rem",
            ...
            >
              ...
              >
                ...
                {/* Stand / Hanger */}
                <path
                  d="M50 10V180M50 170L30 180H70L50 170"
                  stroke="var(--taupe)"
                  strokeWidth="1"
                  strokeLinecap="round"
                  opacity="0.3"
                ...
                <motion.line
                  ...
                  y2="95"
                  stroke={
                    activeSlider === "waist" ? "var(--rose)" : "var(--stone)"
                  }
                  strokeWidth={activeSlider === "waist" ? "3" : "0.8"}
                  opacity={
                    activeSlider && activeSlider !== "waist" ? 0.15 : 0.9
                  }
                  filter={
                    activeSlider === "waist" ? "url(#mannequin-glow)" : "none"
                  }
                  animate={{
                    stroke:
                      activeSlider === "waist" ? "var(--rose)" : "var(--stone)",
                ...
                {gender === "women" ? (
                  <motion.line
                    ...
                    y2="125"
                    stroke={
                      activeSlider === "hips" ? "var(--rose)" : "var(--stone)"
                    }
                    strokeWidth={activeSlider === "hips" ? "3" : "0.8"}
                    opacity={
                      activeSlider && activeSlider !== "hips" ? 0.15 : 0.9
                    }
                    filter={
                      activeSlider === "hips" ? "url(#mannequin-glow)" : "none"
                    }
                    animate={{
                      stroke:
                        activeSlider === "hips"
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  {activeSlider
                    ? `${activeSlider === "hips" && gender === "men" ? "collar" : activeSlider.toUpperCase()} highlight`
                    : "AÉRE Silhouette"}
                </h4>
                <p
                  style={{
                ...
                >
                  {activeSlider === "bust" &&
                    (gender === "women"
                      ? "Measuring around the fullest part of your bust, parallel to the ground."
                      : "Measuring around the widest part of your chest, keeping tape snug under armpits.")}
                  {activeSlider === "waist" &&
                    (gender === "women"
                      ? "Measuring around your natural narrow waist, above the belly button."
                      : "Measuring around your natural waistline, typically where trousers sit.")}
                  {activeSlider === "hips" &&
                    (gender === "women"
                      ? "Measuring around the widest point of your hips, roughly 20cm below waist."
                      : "Measuring around the base of your neck where shirt collar sits comfortably.")}
                  {!activeSlider &&
                    "Hover over or drag a slider to highlight the measurement points on our mannequin form."}
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <div
            className="luxury-glass-panel"
            style={{ padding: "2rem 2.5rem", borderRadius: 0 }}
          >
            <span
              style={{
                fontSize: "0.6rem",
            ...
            >
              Thread a soft measuring tape under your arms, across your shoulder
              blades, and over the fullest part of your chest. Breathe
              naturally, keeping the tape comfortably snug but never tight.
            </p>
          </div>
          <div
            className="luxury-glass-panel"
          ...
          >
            ...
            >
              Find the narrowest part of your waistline, which typically sits
              just above your belly button and below your ribcage. Stand tall,
              relax your muscles, and measure without drawing the tape tight.
            </p>
          </div>
          <div
            className="luxury-glass-panel"
          ...
          >
            ...
            >
              If you fall between sizes or have custom proportions, our Jaipur
              sizing artisans are happy to tailor a bespoke piece. Write to us
              at{" "}
              <a
                href="mailto:hello@aere.in"
                style={{
                  color: "var(--rose)",
            ...
            <table className="size-table">
              ...
              <tbody>
                <tr
                  style={{
                    background:
                      gender === "women" && matchedSize === "XS"
                        ? "rgba(201, 146, 122, 0.08)"
                        : "transparent",
                    fontWeight:
                      gender === "women" && matchedSize === "XS"
                        ? "600"
                ...
                <tr
                  style={{
                    background:
                      gender === "women" && matchedSize === "S"
                        ? "rgba(201, 146, 122, 0.08)"
                        : "transparent",
                    fontWeight:
                      gender === "women" && matchedSize === "S" ? "600" : "400",
                  }}
                >
                  <td>S</td>
                  <td>84-88</td>
                ...
                <tr
                  style={{
                    background:
                      gender === "women" && matchedSize === "M"
                        ? "rgba(201, 146, 122, 0.08)"
                        : "transparent",
                    fontWeight:
                      gender === "women" && matchedSize === "M" ? "600" : "400",
                  }}
                >
                  <td>M</td>
                  <td>88-92</td>
                ...
                <tr
                  style={{
                    background:
                      gender === "women" && matchedSize === "L"
                        ? "rgba(201, 146, 122, 0.08)"
                        : "transparent",
                    fontWeight:
                      gender === "women" && matchedSize === "L" ? "600" : "400",
                  }}
                >
                  <td>L</td>
                  <td>92-96</td>
            ...
            <table className="size-table">
              ...
              <tbody>
                <tr
                  style={{
                    background:
                      gender === "men" && matchedSize === "S"
                        ? "rgba(201, 146, 122, 0.08)"
                        : "transparent",
                    fontWeight:
                      gender === "men" && matchedSize === "S" ? "600" : "400",
                  }}
                >
                  <td>S</td>
                  <td>91-96</td>
                ...
                <tr
                  style={{
                    background:
                      gender === "men" && matchedSize === "M"
                        ? "rgba(201, 146, 122, 0.08)"
                        : "transparent",
                    fontWeight:
                      gender === "men" && matchedSize === "M" ? "600" : "400",
                  }}
                >
                  <td>M</td>
                  <td>96-101</td>
                ...
                <tr
                  style={{
                    background:
                      gender === "men" && matchedSize === "L"
                        ? "rgba(201, 146, 122, 0.08)"
                        : "transparent",
                    fontWeight:
                      gender === "men" && matchedSize === "L" ? "600" : "400",
                  }}
                >
                  <td>L</td>
                  <td>101-106</td>
                ...
                <tr
                  style={{
                    background:
                      gender === "men" && matchedSize === "XL"
                        ? "rgba(201, 146, 122, 0.08)"
                        : "transparent",
                    fontWeight:
                      gender === "men" && matchedSize === "XL" ? "600" : "400",
                  }}
                >
                  <td>XL</td>
                  <td>106-111</td>
                ...
                <tr
                  style={{
                    background:
                      gender === "men" && matchedSize === "XXL"
                        ? "rgba(201, 146, 122, 0.08)"
                        : "transparent",
                    fontWeight:
                      gender === "men" && matchedSize === "XXL" ? "600" : "400",
                  }}
                >
                  <td>XXL</td>
                  <td>111-116</td>
        ...
        <div className="info-grid" style={{ marginBottom: "6rem" }}>
          <div className="info-card" style={{ borderRadius: 0 }}>
            <h3>Relaxed Fit</h3>
            <p>
              Our linen pieces and co-ords are designed with extra ease. If
              between sizes, size down for a more tailored look.
            </p>
          </div>
          <div className="info-card" style={{ borderRadius: 0 }}>
            <h3>Tailored Fit</h3>
            <p>
              Silk blouses and trousers follow a more structured fit. We
              recommend your true size for these pieces.
            </p>
          </div>
          <div className="info-card" style={{ borderRadius: 0 }}>
            <h3>Knitwear</h3>
            <p>
              Our cashmere and wool knits have natural stretch. Size down for a
              closer fit, or take your usual size for oversized styling.
            </p>
          </div>
          <div className="info-card" style={{ borderRadius: 0 }}>
            <h3>Sustainability Focus</h3>
            <p>
              Handcrafting to order prevents inventory overheads and textile
              waste. Knowing your perfect fit helps us maintain zero waste.
            </p>
          </div>
        </div>
      </div>
