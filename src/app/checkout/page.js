...
export default function CheckoutPage() {
  ...
  const getCardThemeGradient = (num) => {
    ...
    if (type === "Visa")
      return "linear-gradient(135deg, #132247 0%, #15100d 100%)";
    if (type === "Mastercard")
      return "linear-gradient(135deg, #421118 0%, #15100d 100%)";
    if (type === "American Express")
      return "linear-gradient(135deg, #0c3329 0%, #15100d 100%)";
  ...
  const handleShippingNext = () => {
    ...
    if (!form.pincode.trim() || !/^\d+$/.test(form.pincode))
      return showToast("Pincode is required and must be numeric");
    ...
    try {
      ...
      const res = await fetch("/api/orders", {
        ...
        body: JSON.stringify({
          ...
          email: form.email,
          payment_method:
            payMethod === "biometric" ? "AÉRE Express Pay" : payMethod,
    ...
    <div className="checkout-layout">
      <div>
        <div className="checkout-steps">
          <button
            className={`checkout-step ${step >= 1 ? "active" : ""} ${step > 1 ? "done" : ""}`}
            onClick={() => setStep(1)}
          >
            1. Contact
          </button>
          <button
            className={`checkout-step ${step >= 2 ? "active" : ""} ${step > 2 ? "done" : ""}`}
        ...
        {step === 1 && (
          <div>
            ...
            <button className="btn-primary" onClick={handleContactNext}>
        ...
        {step === 2 && (
          <div>
            ...
            <button className="btn-primary" onClick={handleShippingNext}>
              Continue to Payment
            </button>
          </div>
        )}
        ...
        {step === 3 && (
          <div>
            ...
            >
              ...
              >
                <div>
                  <strong style={{ color: "#d69f87", fontWeight: 500 }}>
                    Name:
                  </strong>{" "}
                  {form.name}
                </div>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    gap: "1.5rem",
                    marginBottom: "2rem",
                    borderBottom: "1px solid rgba(158,139,124,.15)",
                ...
                >
                  <button
                    ...
                    style={{
                      ...
                      padding: "0.5rem 0",
                      color:
                        payMethod === "cod" ? "var(--ink)" : "var(--taupe)",
                      borderBottom:
                        payMethod === "cod"
                          ? "2px solid var(--rose)"
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: "0.5rem 0",
                      color:
                        payMethod === "card" ? "var(--ink)" : "var(--taupe)",
                      borderBottom:
                        payMethod === "card"
                          ? "2px solid var(--rose)"
                          : "2px solid transparent",
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: "0.5rem 0",
                      color:
                        payMethod === "upi" ? "var(--ink)" : "var(--taupe)",
                      borderBottom:
                        payMethod === "upi"
                          ? "2px solid var(--rose)"
                          : "2px solid transparent",
                ...
                {payMethod === "cod" && (
                  ...
                  >
                    Cash on Delivery (COD). You may pay via cash or secure
                    UPI/QR code once the shipment arrives at your doorstep.
                  </p>
                )}
                ...
                {payMethod === "card" && (
                  <div>
                    ...
                    <div className="payment-card-3d-wrap">
                      <div
                        className={`payment-card-3d ${isCardFlipped ? "flipped" : ""}`}
                      >
                        {/* Front Face */}
                        <div
                          className="card-3d-face card-face-front"
                          style={{
                            background: getCardThemeGradient(card.number),
                          }}
                        >
                          <div
                            style={{
                        ...
                        <div className="card-3d-face card-face-back">
                          ...
                          <div className="card-signature-area">
                            <span className="card-signature-label">
                ...
                {payMethod === "biometric" && (
                  <div className="biometric-scanner-wrap">
                    <div
                      className={`biometric-scanner-ring ${biometricState === "scanning" ? "scanning" : ""} ${biometricState === "success" ? "success" : ""}`}
                    >
                    ...
                    >
                      {biometricState === "idle" &&
                        "Position face for AÉRE Express Secure Pay"}
                      {biometricState === "scanning" &&
                        "SECURE BIOMETRIC SCANNING... PLEASE HOLD"}
                      {biometricState === "success" &&
              ...
              <div
                style={{
                  ...
                  border: "1px solid rgba(158,139,124,0.15)",
                }}
              >
      ...
      <div className="order-summary">
        ...
        <div className="cart-summary-row" style={{ marginTop: "1.5rem" }}>
          <span>Subtotal</span>
        ...
        <div className="atelier-promo-box">
          ...
          {activePromo && (
            <div className="promo-tag-active">
              <span>
                ✨ Applied: {activePromo} (-{discountPercent}%)
              </span>
            </div>
          )}
        </div>
