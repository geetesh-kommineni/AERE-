...
const MILESTONES = [
  {
    ...
    metrics: [{ val: '1', label: 'Jaipur Atelier' }, { val: '4', label: 'Master Weavers' }],
    stamp: 'JAIPUR'
  },
  {
    year: '2024',
    ...
    image: 'https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=800&q=80&auto=format',
    quote: '"We choose materials that remember the soil they came from."',
    metrics: [{ val: '8', label: 'Artisan Hubs' }, { val: '60+', label: 'Certifications' }],
    stamp: 'ORGANIC'
  },
  {
    year: '2025',
    ...
    metrics: [{ val: '100%', label: 'Natural Dyes' }, { val: '0%', label: 'Synthetic Waste' }],
    stamp: 'ZERO'
  },
  {
    year: '2026',
    ...
    metrics: [{ val: '18+', label: 'Years of Craft' }, { val: '46', label: 'Countries Shipped' }],
    stamp: 'M-2026'
  }
];
    ...
    <div ref={trackRef} style={{ height: '400vh', position: 'relative' }}>
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <span style={{ fontSize: '0.62rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: 'var(--rose)', display: 'block', fontWeight: 600 }}>
              Chronicle
            </span>
            <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.8rem', fontWeight: 300, color: 'var(--ink)', margin: '0.25rem 0 0' }}>
        ...
        <motion.div
          style={{ x, display: 'flex', width: '400vw', height: '70vh', alignItems: 'center' }}
        >
          {MILESTONES.map((m, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span style={{ fontFamily: 'var(--serif)', fontSize: '18rem', fontWeight: 300, letterSpacing: '-0.05em' }}>
                    {m.stamp}
                  </span>
                </motion.div>
                ...
                >
                  <span style={{ fontSize: '0.62rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--rose)', marginBottom: '0.85rem', display: 'block', fontWeight: 600 }}>
                    {m.year} · {m.subtitle}
                  </span>
                  
                  <h3 style={{ fontFamily: 'var(--serif)', fontSize: '2.8rem', fontWeight: 300, color: 'var(--ink)', lineHeight: 1.15, marginBottom: '1.5rem' }}>
                    {m.title}
                  </h3>
                  
                  <p style={{ fontSize: '0.82rem', color: 'var(--stone)', lineHeight: 1.8, marginBottom: '2rem' }}>
                    {m.text}
                  </p>
                  
                  <blockquote style={{ fontSize: '1.1rem', fontFamily: 'var(--serif)', fontStyle: 'italic', color: 'var(--taupe)', borderLeft: '2.5px solid var(--rose)', paddingLeft: '1.25rem', marginBottom: '2rem', marginInlineStart: 0 }}>
                    {m.quote}
                  </blockquote>
                  ...
                  <div style={{ display: 'flex', gap: '3rem' }}>
                    {m.metrics.map((met, metIdx) => (
                      <div key={metIdx}>
                        <div style={{ fontFamily: 'var(--serif)', fontSize: '1.8rem', fontWeight: 300, color: 'var(--ink)' }}>{met.val}</div>
                        <div style={{ fontSize: '0.62rem', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--taupe)', marginTop: '0.15rem' }}>{met.label}</div>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <div style={{
          ...
          <Link href="/sustainability" className="btn-primary" style={{ fontSize: '0.72rem', padding: '0.6rem 1.8rem' }}>
