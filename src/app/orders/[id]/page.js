...
export default function OrderDetailPage({ params }) {
  ...
  const currentStepIndex =
    statuses.indexOf(order.status) !== -1 ? statuses.indexOf(order.status) : 0;
            ...
            {["confirmed", "tailoring", "shipped", "delivered"].map((st) => (
              <button
                ...
                style={{
                  ...
                  background:
                    order.status === st ? "var(--rose)" : "transparent",
            ...
            {order.items?.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  gap: "1rem",
                  padding: "1rem 0",
                  borderBottom: "1px solid rgba(158,139,124,.12)",
                }}
              >
                {item.product_image && (
                  <img
                ...
                <div>
                  <div
                    style={{ fontFamily: "var(--serif)", fontSize: ".95rem" }}
                  >
                    {item.product_name}
                  </div>
