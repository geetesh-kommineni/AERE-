  ...
  return (
    <>
      <div className="page-hero">
        ...
        <h1>
          Atelier Capsule <em>Stylist</em>
        </h1>
        <p>
          Answer three considered questions to curate a bespoke 3-piece quiet
          luxury capsule look, balanced for your lifestyle.
        </p>
      </div>

      <div
        className="page-content"
        style={{ maxWidth: "1000px", margin: "0 auto", paddingBottom: "8rem" }}
      >
              ...
              >
                {[
                  ...
                  >
                    ...
                    >
                      Vibe 0
                      {v.key === "ivory" ? 1 : v.key === "terracotta" ? 2 : 3}
                    </span>
                    <h4
                      style={{
                        fontFamily: "var(--serif)",
              ...
              >
                {[
                  ...
                  >
                    ...
                    >
                      Atmosphere 0
                      {a.key === "jaipur" ? 1 : a.key === "monsoon" ? 2 : 3}
                    </span>
                    <h4
                      style={{
                        fontFamily: "var(--serif)",
          ...
          {step === 3 && (
            ...
            >
              <div style={{ textAlign: "center", marginBottom: "4rem" }}>
                ...
                >
                  Three meticulously selected pieces harmonized in tone,
                  texture, and silhouette to breathe together beautifully.
                </p>
              </div>
              ...
              >
                <div>
                  ...
                  <span style={{ fontSize: "0.68rem", color: "var(--taupe)" }}>
                    Includes 3 pieces · Complimentary Artisan Packaging &
                    Delivery
                  </span>
                </div>
                <div
