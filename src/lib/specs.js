export function getWeaveSpecs(material) {
  ...
  if (m.includes('linen')) {
    return {
      ...
      details: 'Hand-harvested flax fibers woven with traditional plain cross-structures. Showcases authentic irregular slub nodes for natural, airy ventilation.'
    };
    ...
    return {
      ...
      details: 'Concealed floating warp lines cross over four weft threads, creating a highly lustrous, liquid-drape reflection that floats organically over the skin.'
    };
    ...
    return {
      ...
      details: 'Crafted from ultra-fine undercoat cashmere fibers (under 15 microns) loop-interlocked for maximum thermal loft and luxurious softness.'
    };
    ...
    return {
      ...
      details: 'Unaltered full-grain calf leather utilizing organic vegetable dyes. Displays natural grain patterns with self-healing properties.'
    };
    ...
    return {
      ...
      details: 'Regenerated cellulose fibers derived from sustainably harvested wood pulp. Woven into a micro-fine weave for a cooling skin touch.'
    };
  } else { // Default to Cotton / Cotton Canvas / Denim / Gabardine
    return {
      type: 'cotton',
      ...
      details: 'Premium long-staple organic cotton fibers combed to remove short fly fibers and spun tightly for durable, structured, and soft luxury drapes.'
    };
  }
}
