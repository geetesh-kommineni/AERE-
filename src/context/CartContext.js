...
export function CartProvider({ children }) {
      ...
      return [...prev, {
        ...
        image: (() => {
          ...
          if (typeof product.images === 'object') {
            const colorImages = product.images[color] || Object.values(product.images)[0] || [];
  ...
  return (
    <CartContext.Provider value={{ cart, addToCart, removeFromCart, updateQuantity, clearCart, totalItems, subtotal, shipping, total, isDrawerOpen, setIsDrawerOpen }}>
      {children}
